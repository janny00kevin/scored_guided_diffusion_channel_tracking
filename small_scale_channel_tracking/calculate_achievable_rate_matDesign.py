...
OUTPUT_DIR = os.path.join(SCRIPT_DIR, "achievable_rate_plot_matDesign")
if not os.path.exists(OUTPUT_DIR):
    os.makedirs(OUTPUT_DIR)

Z_FILE_TX = os.path.join(DATA_DIR, "impedance_matrix_matlab2", "Z_results", f"{TX_DIM[0]}x{TX_DIM[1]}_UPA_{FREQ_GHZ}GHz_Z_matDesign.mat")
Z_FILE_RX = os.path.join(DATA_DIR, "impedance_matrix_matlab2", "Z_results", f"{RX_DIM[0]}x{RX_DIM[1]}_UPA_{FREQ_GHZ}GHz_Z_matDesign.mat")
EIGEN_FILE_TX = os.path.join(DATA_DIR, "impedance_matrix_matlab2", "eigen_result", f"{TX_DIM[0]}x{TX_DIM[1]}_UPA_{FREQ_GHZ}GHz_eigen_matDesign.mat")
EIGEN_FILE_RX = os.path.join(DATA_DIR, "impedance_matrix_matlab2", "eigen_result", f"{RX_DIM[0]}x{RX_DIM[1]}_UPA_{FREQ_GHZ}GHz_eigen_matDesign.mat")
...
def main():
    ...
    # Save Filename
    filename = f"Rate_{FREQ_GHZ}GHz_{TX_DIM[0]}x{TX_DIM[1]}Tx_{RX_DIM[0]}x{RX_DIM[1]}Rx_RT{R_T}_RR{R_R}_matDesign.png"
