...
Z_RESULTS_DIR = os.path.join(DATA_DIR, "impedance_matrix_matlab2", "Z_results")
EIGEN_RESULTS_DIR = os.path.join(DATA_DIR, "impedance_matrix_matlab2", "eigen_result")
...
Z_FILE_TX = os.path.join(Z_RESULTS_DIR, f"{TX_DIM[0]}x{TX_DIM[1]}_UPA_{FREQ_GHZ}GHz_Z_matDesign.mat")
Z_FILE_RX = os.path.join(Z_RESULTS_DIR, f"{RX_DIM[0]}x{RX_DIM[1]}_UPA_{FREQ_GHZ}GHz_Z_matDesign.mat")

EIGEN_FILE_TX = os.path.join(EIGEN_RESULTS_DIR, f"{TX_DIM[0]}x{TX_DIM[1]}_UPA_{FREQ_GHZ}GHz_eigen_matDesign.mat")
EIGEN_FILE_RX = os.path.join(EIGEN_RESULTS_DIR, f"{RX_DIM[0]}x{RX_DIM[1]}_UPA_{FREQ_GHZ}GHz_eigen_matDesign.mat")
# ==========================================
# 2. Helper Functions
# ==========================================
