...
def get_tracking_testing_dataset(script_dir, num_samples, rho, freq_ghz):
    dataset_dir = os.path.join(script_dir, "data", "training_testing_dataset")
    filename = f"tracking_test_nondiag_rho{rho:.3f}_{freq_ghz}GHz_{num_samples}samples.pt"
