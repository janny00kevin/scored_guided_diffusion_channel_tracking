...
for i = 1:length(freqs)
    f = freqs(i);
    filename = sprintf('%dx%d_UPA_%.0fGHz_eigen_matDesign.mat', ...
        grid_size(1), grid_size(2), f);
...
% --- Save Figure ---
file_name = sprintf('%dx%d_matDesign_Energy_Comparison_Magnitude_Sorted.png', grid_size(1), grid_size(2));
